...
export function absoluteUrl(req?: IncomingMessage, localhostAddress = 'localhost:3000') {
...
export function getHostURL(req?: IncomingMessage, localhostAddress = 'localhost:3000') {
